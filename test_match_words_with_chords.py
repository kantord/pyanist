...
def test_phonetic_spelling_example_2():
    assert list(chord_matcher.get_all_spellings("automatically", SPELLING_RULES))[0] == "awtamatikli"

def test_all_possible_spellings_are_generated_1():
    assert "autamatikli" in chord_matcher.get_all_spellings("automatically", SPELLING_RULES)

def test_all_possible_spellings_are_generated_2():
    assert "awtamatikly" in chord_matcher.get_all_spellings("automatically", SPELLING_RULES)

def test_all_possible_spellings_are_generated_3():
    assert "autamatikly" in chord_matcher.get_all_spellings("automatically", SPELLING_RULES)
...
def test_multiple_spelling_variants_are_considered_when_matching_chord():
    ...
    assert chord_matcher.get_best_remaning_chord("automatically", chords) == ("a", "u", "t", "y")
