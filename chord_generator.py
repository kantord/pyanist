...
hand_rows = [
    (tuple(sorted(set('qwert'))), tuple(sorted(set('asdfg'))), tuple(sorted(set('zxcvb')))),
...
def generate_chords():
    for fingers_to_use in chain(combinations(fingers, 3), combinations(fingers, 4), combinations(fingers, 5)):
